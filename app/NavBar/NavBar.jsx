...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-100 w-screen px-10 py-4 fixed z-20">
      <div className="container mx-auto flex justify-between items-center">
        <PageWrapper>
          <Link href={"/"}>
            <div className="text-gray-700 font-bold text-xl">
              Vyz<span className="text-red-500 font-thin">Onix</span>{" "}
            </div>
          </Link>
        </PageWrapper>
        ...
        >
          <div className="text-lg lg:flex-grow">
            ...
            <Link href={"/ServiceCard"}>
              <p className="block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-gray-500">
                Services
              </p>
            </Link>
            <a
